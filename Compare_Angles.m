function [Compare] = Compare_Angles(Joint_Angles)
...
% Temporary Input: Compare_Angles([1; 1; 1; 1; 1; 1; 1])
...
if a+b+c+d+e+f+g == 7
    A = 'The configuration is not reachable';
    Compare = A;
else
    B = 'The configuration is reachable';
    Compare = B;
